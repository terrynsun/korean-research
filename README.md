...
* Another Dictionary: directly scrapped from the text dictionary data (English Word - POS Tag - Meaning format. Idioms (either noun or verbal phrases) do not have POS Tag. If there are more than one meanings, then it is separated either by semicolon or comma)
